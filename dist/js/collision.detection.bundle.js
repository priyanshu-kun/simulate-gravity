...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/js/collision.detection.js");
/******/ })
/************************************************************************/
/******/ ({
...
var Circle = /*#__PURE__*/function () {
  ...
  _createClass(Circle, [{
    ...
    value: function update() {
      this.draw(); // here update circle properties
    }
  }]);
...
function animate() {
  ...
  c2.x = mouse.x;
  c2.y = mouse.y;
  c2.update(); // console.log(getDistance(c1.x,c1.y,c2.x,c2.y))
...
/******/ });
//# sourceMappingURL=collision.detection.bundle.js.map